...
pub fn text(source: &str) -> Option<&'static str> {
    Some(match source {
        ...
        "Opposite-direction overlap" => "Solapamiento de direcciones opuestas",
        "Neutral gap (neither key active)" => "Intervalo neutro (ninguna tecla activa)",
        "A output active" => "Salida A activa",
        "D output active" => "Salida D activa",
